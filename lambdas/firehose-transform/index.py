...
def handler(event, context):
    ...
    for record in event["records"]:
        try:
            ...
            # Place resource ARNs into their respective log fields
            for resource in parsed_entry["resources"]:
                resource_type = resource.split(":")[5]
                if resource_type == "application":
                    payload["applicationArn"] = resource
                elif resource_type == "deploymentgroup":
                    payload["deploymentgroupArn"] = resource
                elif resource_type == "instance":
                    payload["instanceArn"] = resource
